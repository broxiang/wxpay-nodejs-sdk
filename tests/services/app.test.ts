...
describe('AppService', () => {
  ...
  describe('prepayWithRequestPayment', () => {
    it('should create order and return bridgeConfig', async () => {
      ...
      expect(result.bridgeConfig.prepayId).toBe('wx201410272009395522657a690389285100');
      expect(result.bridgeConfig.packageValue).toBe('Sign=WXPay');
    });
  });
});
