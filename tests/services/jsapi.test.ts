...
import { JsapiService } from '../../src/services/jsapi';
...
describe('JsapiService', () => {
  ...
  beforeEach(() => {
    ...
    service = new JsapiService(mockClient as unknown as WxPayClient);
  });

  // ============= createOrder =============

  describe('createOrder', () => {
    it('should create a JSAPI order and return prepay_id', async () => {
      const request: CreateJsapiOrderRequest = {
