...
import { H5Service } from '../../src/services/h5';
...
describe('H5Service', () => {
  ...
  beforeEach(() => {
    ...
    service = new H5Service(mockClient as unknown as WxPayClient);
  });

  // ============= createOrder =============

  describe('createOrder', () => {
    it('should create an H5 order and return h5_url', async () => {
      const request: CreateH5OrderRequest = {
    ...
    it('should create H5 order with iOS scene_info', async () => {
      const request: CreateH5OrderRequest = {
        appid: 'wx8888888888888888',
        mchid: '1900000100',
        description: '测试商品',
        ...
        scene_info: {
          ...
          h5_info: {
            type: 'iOS',
            wch5_url: 'https://example.com/pay',
          },
        },
      };
      ...
      mockClient.post.mockResolvedValue({
        status: 200,
        headers: {},
        data: { h5_url: 'https://wx.tenpay.com/test' },
      });
